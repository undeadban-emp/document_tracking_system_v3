     ...
     <div class="card-body">
          <form action="{{ route('admin.office.store') }}" method="POST">
               ...
               <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                         <input class="form-control @error('code') is-invalid @enderror" type="text" value="{{  $latestCode }}" id="code" name="code" readonly>
                         @error('code')
               ...
               <div class="mb-3 row">
                    ...
                    <div class="col-md-8">
                         <input class="form-control @error('shortname') is-invalid @enderror" type="text" value="{{ old('shortname') }}" id="shortname" name="shortname">
                         @error('shortname')
                         <span class="invalid-feedback" role="alert">
                              {{ $message }}
                         </span>
